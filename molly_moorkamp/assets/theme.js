  ...
  var Search = function () {
    ...
    _createClass(Search, [{
        ...
        Promise.all(queries).then(function (responses) {
          ...
          Promise.all(responses.map(function (response) {
            ...
            if (window.theme.searchMode === 'product') {
              ...
              // if no results add class to search
              if (!contents[0].includes("No results")) {
                document.querySelector('.Search').classList.add("productFound");
              } else {
                document.querySelector('.Search').classList.remove("productFound");
                document.querySelector('.Search').classList.add("productNotFound");
              }
            } else {
      ...
      value: function _resetSearch() {
        ...
        document.querySelector('.Search').classList.remove("productFound");
        document.querySelector('.Search').classList.remove("productNotFound");
  ...
  var LoginSection = function () {
    ...
    _createClass(LoginSection, [{
      ...
      value: function _showRecoverPassword() {
        ...
        if (isLoginActive) {
          this.timelineLite.fromTo(this.customerLoginForm, 0.5, { autoAlpha: 1, display: 'block', y: 0 }, { autoAlpha: 0, y: 20, display: 'none' }).fromTo(this.recoverPasswordForm, 0.5, { autoAlpha: 0, display: 'none', y: 20 }, { autoAlpha: 1, display: 'block', y: 0, delay: 0.015 });
          loginWrapper.classList.remove('login__open_start');
        } else {
          this.timelineLite.fromTo(this.recoverPasswordForm, 0.5, { autoAlpha: 1, display: 'block', y: 0 }, { autoAlpha: 0, y: 20, display: 'none' }).fromTo(this.customerLoginForm, 0.5, { autoAlpha: 0, display: 'none', y: 20 }, { autoAlpha: 1, display: 'block', y: 0, delay: 0.015 });
